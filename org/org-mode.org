...
The rest of this document describes customizations I use in my setup, how I structure org-mode files, and other changes to fit the way I want org-mode to work. ** Organizing Your Life Into Org Files
:PROPERTIES:
:CUSTOM_ID: OrgFiles
:END:
...
#+begin_src plantuml :file normal_task_states.svg :cache yes
title Task States
[*] -> TODO
TODO -> NEXT
TODO -> DONE
...
#+RESULTS[177d728310c9d57e96cd1a43f2f33e00b44bdbac]:
[[file:normal_task_states.svg]]
...
,* TODO 
  ...
  [[file:~/git/org-mode-doc/org-mode.org::*Capture Tasks is all about being FAST][Capture Tasks is all about being FAST]]
#+end_src
...
(setq org-columns-default-format "ITEM(Task) Effort(Effort){:} CLOCKSUM")
#+end_src
...
(setq org-time-clocksum-format
      '(:hours "%d" :require-hours t :minutes ":d" :require-minutes t))
#+end_src
