#+LATEX_CLASS: cas-dc
#+LATEX_CLASS_OPTIONS: [a5paper,18pt,oneside,fleqn,final]
...
#+LATEX_HEADER: \definecolor{lightgray}{gray}{0.90}
#+LATEX_HEADER: \sethlcolor{lightgray}
#+LATEX_HEADER: \setcounter{tocdepth}{2}

#+BEGIN_EXPORT latex

\title[mode = title]{FMCG WP1.3 LASER TEXTURING}
\title[mode = alt]{ARTC - University of Coventry collaboration}

\shorttitle{FMCG Laser Texturing}
\shortauthors{Chu PL et~al.}

\author{Chu PL}[style=chinese, orcid=0000-0000-0000-0000]
\ead{chu_pau_loong@artc.a-star.edu.sg}

\author{David G. Waugh}
\ead{ac4963@coventry.ac.uk}
