...
function configure(grabber)
{
	...
	grabber.InterfacePort.set("LineSelector", "TTLIO22");
	grabber.InterfacePort.set("LineMode", "Output");
	grabber.InterfacePort.set("LineSource[TTLIO22]", "Device3Strobe");
	grabber.InterfacePort.set("LineMode[IIN22]", "Input");
	grabber.InterfacePort.set("LineInputToolSource[LIN4]", "IIN22");
	grabber.InterfacePort.set("LineInputToolActivation[LIN4]", "RisingEdge");
