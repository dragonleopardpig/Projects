...
function configure(grabber)
{
	...
	grabber.InterfacePort.set("LineSource[TTLIO11]", "Device0Strobe");
	grabber.InterfacePort.set("LineMode[IIN11]", "Input");
	grabber.InterfacePort.set("LineInputToolSource[LIN1]", "IIN11");
	grabber.InterfacePort.set("LineInputToolActivation[LIN1]", "RisingEdge");
